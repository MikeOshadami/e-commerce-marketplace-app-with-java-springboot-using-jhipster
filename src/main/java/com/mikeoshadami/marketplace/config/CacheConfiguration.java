package com.mikeoshadami.marketplace.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mikeoshadami.marketplace.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mikeoshadami.marketplace.repository.UserRepository.USERS_BY_EMAIL_CACHE);
