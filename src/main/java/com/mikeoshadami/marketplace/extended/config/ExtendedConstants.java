...
public class ExtendedConstants {
    ...
    public enum ResponseCode {
        ...
        ACCOUNT_BLOCK("69", "Account is blocked"),
        ...
        ACCOUNT_UNBLOCK("70", "Account is unblock"),
        ...
        COMPLETE_AMOUNT_UNBLOCK("112", "Amount Unblock Is Completed"),
        TRANSACTION_NOT_PERMITTED("57", "Transaction not permitted to sender"),;
